...
function [WEC, Turb] = Init_Mutriku(Turbine_type,n_SS,n_CL)
...
h_ch = 7.45;              % Chamber height between B.M.V.E h_ch = 9.70 - 0.00 
...
%                 Turb.a = Kopt_wells(6);
    ...
    case 3
        ...
        %% Rotational speed control
        % Fixed speed
        Turb.Om_vect = [100 110 110 110 120 130 140 150 165 170 190 195 215 220];
        for i = 1:14
            if Turb.Om_vect(i) > Turb.Om_co
                Turb.Om_vect(i) = Turb.Om_co*0.96;              
            end
