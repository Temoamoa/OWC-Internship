...
Days = 1;%:28;%17;%1:19; du 1 au 6 pas de data pour mars
Demi_Hours = 0:47;%48:48; %On commence a 00h00
Month = '4-';

%Time.ini = '2018-04-01 09:50:00.000';
%Time.outi= '2018-04-01 10:00:00.000';

DB_FullFev_withoutstates = DBaccess(Month,Days,Demi_Hours);
DB_FullFev_withoutstates = Mejorar(DB_FullFev_withoutstates,Days,Demi_Hours);
